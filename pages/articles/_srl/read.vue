...
<article>
  ...
  <nav-bottom>
    <template slot="left">
      <button-basic label="Index" :to="makeButtonUrl('index')"/>
    </template>
    <template slot="right">
      <button-basic v-if="nest_srl" label="Add" :to="makeButtonUrl('add')"/>
      <button-basic label="Edit" :to="makeButtonUrl('edit', srl)" color="key"/>
      <button-basic label="Delete" :to="makeButtonUrl('delete', srl)" color="gray"/>
    </template>
  </nav-bottom>
</article>
</template>
